...
export declare class IntegradorDmsNbsService {
    ...
    getVendasFaturadas(codEmpresa: string, periodo: string, departamento: string): Promise<VendaNbs[]>;
    getVendasAFaturar(codEmpresa: string, periodo: string, departamento: string): Promise<VendaNbs[]>;
